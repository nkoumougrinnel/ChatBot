...
- Boucle de rétroaction: mauvaise FAQ â†’ scores bas â†’ moins visible

## Impact

âœ“ Active learning: le système s'améliore avec chaque feedback
âœ“ avg_score reflect la satisfaction réelle (pas juste la similarité technique)
âœ“ Endpoint `/api/stats/` montre clairement les FAQs problématiques
