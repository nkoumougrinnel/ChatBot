...
from chatbot.engine.rag_pipeline import ask, ask_stream, health as pipeline_health
...
def llm_status(request):
    """
    Vérifie la disponibilité d'Ollama et l'état général du pipeline.
    ...
    Response 200 :
        {
            ...
            "model": str,
            "error": str | null,
            "pipeline": { faiss_loaded, tfidf_loaded, ollama_available, ready, ... }
        }
    """
