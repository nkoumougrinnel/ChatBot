...
Ces routes sont montées sous le préfixe versionné /api/v2/ pour éviter toute
collision avec l'endpoint Phase 1 /api/chatbot/ask/. Endpoints exposés :
    /api/v2/chatbot/status/
    /api/v2/chatbot/ask/
    /api/v2/chatbot/test-llm/
    /api/v2/chatbot/reload-index/
"""
